...
(function( $, window, undefined ) {
	...
	$.mobile = $.extend($.mobile, {
		...
		pageLoadErrorMessage: "Sory Page is Not Available",
...
$.extend( $.support, {
	cssTransitions: "WebKitTransitionEvent" in window ||
		validStyle( 'transition', 'height1 100ms linear', [ "Webkit", "Moz", "" ] ) &&
...
(function( $, undefined ) {
	...
	$.mobile.resetActivePageHeight = function resetActivePageHeight( height ) {
		...
		//aPage.css( "min-height", height - aPagePadT - aPagePadB - aPageBorderT - aPageBorderB );  //custom_content();
	};
...
(function( $ ) {
	var	meta = $( "meta[name=viewport]" ),
		...
		disabledZoom = initialContent + ",initial-scale=1, maximum-scale=1, user-scalable=no",
		enabledZoom = initialContent + ",initial-scale=1, maximum-scale=1, user-scalable=no",
		disabledInitially = //.test( initialContent );
